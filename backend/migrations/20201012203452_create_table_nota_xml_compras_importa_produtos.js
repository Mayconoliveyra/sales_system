exports.up = function (knex) {
    return knex.schema.createTable("nota_xml_compras_importa_produtos", table => {
        ...
        table.decimal("codigo_importacao_produto", 74, 0).notNull() // (tamanho maximo 74, 0 casa decimais) codigo de importação, gerado atraves do numero do cnpj do emitente + codigo do produto
