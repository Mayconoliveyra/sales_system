    ...
    <ul>
      ...
      <li @click="toggleProdutos">
        ...
        <ul v-if="produtosMenuVisible">
          ...
          <li @click="toggleMenu">
            <router-link to="/admin/produtos/valores_venda">
              <i class="fa fa-usd"></i>Valores de venda
            </router-link>
          </li>
          <li @click="toggleMenu">
            <router-link to="/admin/produtos/opcoes_auxiliares">
      ...
      <li @click="toggleEstoque">
        ...
        <ul v-if="estoqueMenuVisible">
          ...
          <li @click="toggleMenu">
            <router-link to="/">
              <i class="fa fa-building-o"></i>Cotações
            </router-link>
          </li>
          <li @click="toggleMenu">
            <router-link to="/admin/estoque/compras">
